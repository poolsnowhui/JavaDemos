...
public class SendMailUtil {
	 ...
	 * @return 成功或失败
	 */
	public static boolean send(String to, String subject, String content, String smtp, String host, String sendName,
			String sendPort, String userName, String userPwd) {
		...
		try {
			...
			System.out.println(nick + " <" + sendName + ">");
			...
			/*
			 * //抄送人 Address ccAddress = new
			 * InternetAddress("first.lady@whitehouse.gov");
	...
	public static void main(String[] args) {
		// 您要发送给谁，标题，内容
		SendMailUtil.send("qazcxh@163.com", "javamail测试", "javamail测试", "smtp", 
				"smtp.qq.com", "381727457@qq.com", "25", "381727457@qq.com",
				"P001**hui");
	}
}